...
document.write('.tableBorder7{width:800;solid; background-color: #000000;}');
document.write('TD{font-family: 宋体;font-size: 12px;line-height : 15px ;}');
document.write('th{background-color: #f7f7f7;color: #000000;font-size: 12px;font-weight:bold;}');
document.write('th.th1{background-color: #19ACA6;}');
document.write('td.TableBody7{background-color:#EAF4FD;}');
document.write('</style>');
document.write('<div id=pltsTipLayer style="display: none;position: absolute; z-index:200"></div>');
...
{  var o=event.srcElement;
    ...
    if(pltsPop!=null&&pltsPop!=""&&typeof(pltsPop)!="undefined")
    {
       ...
       if(!re.test(Msg))pltsTitle="<font color=#ffffff>提示</font>";
         ...
         Msg=Msg.replace(re,"");
         Msg=Msg.replace("<br>","");}
         //var attr=(document.location.toString().toLowerCase().indexOf("http://www.qpsh.com")>0?"nowrap":"");
               var content =
