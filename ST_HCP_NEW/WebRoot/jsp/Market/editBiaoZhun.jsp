...
function save() {
	document.forms[0].action = "<%=request.getContextPath()%>/saveEditBiaoZhun.action";
                ...
                <td style="width: 100%;">
                    ...
                    <div style="" class="Btntoolbar_right">
                        ...
                        <input type="button" name="btnSave1" value="保存" onclick="save()"
                            id="Submit1"  style="display: ;"   class="pt_Long_button" />      <input type="button" value="返回"
